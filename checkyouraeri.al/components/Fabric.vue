...
export default {
    ...
    mounted() {
        ...
        community.on('selected', ()=> {
            this.changePage("/get-involved")
        })
        ...
        // fabric.loadSVGFromURL('/assets/images/check-your-aerial.svg',function(objects, options){
        ...
        // fabric.loadSVGFromURL('/assets/images/aerial-comp.svg',function(objects, options){
        // var svgData = fabric.util.groupSVGElements(objects, options);
        // svgData.top = padding;
        ...
        // fabric.loadSVGFromURL('/assets/images/logo.svg?v=2',function(objects, options){
        // var svgData = fabric.util.groupSVGElements(objects, options);
        // svgData.top = 300;
        ...
        // fabric.Image.fromURL('/assets/images/aerial-1.jpg', function(myImg) {
